-- Historique privé et immuable des indicateurs collectés par plateforme.
CREATE TABLE public.artist_metric_snapshots (
  ...
  CONSTRAINT artist_metric_snapshots_collection_key
    UNIQUE (artist_id, platform, collected_at)
);
...
-- Reprendre les dernières valeurs déjà enregistrées dans les identités plateforme.

...
comment on table public.contributions is
  'Contributions volontaires Ã  PlanÃ¨te HMI. Les visiteurs passent exclusivement par les routes serveur.';
comment on column public.contributions.provider_payload is
  'RÃ©ponse fournisseur minimale et nettoyÃ©e. Ne doit contenir aucun secret.';
comment on column public.contributions.proof_storage_path is
  'Chemin privÃ© dans le bucket contribution-proofs.';

-- K7 — publication, révision et restauration atomiques du classement YouTube.
...
-- Les RPC K3–K7 sont SECURITY INVOKER : le rôle serveur doit posséder les
-- privilèges de table correspondants. anon/authenticated restent soumis aux
-- restrictions et révocations existantes.
...
BEGIN
  ...
  INSERT INTO public.chart_audit_logs(
    ...
    CASE WHEN p_restored_from_publication_id IS NULL THEN 'Publication manuelle'
         ELSE 'Restauration enregistrée' END
  );

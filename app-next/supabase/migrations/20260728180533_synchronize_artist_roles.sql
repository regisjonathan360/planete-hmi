-- =========================================================
-- Planète HMI — Synchronisation rôles ↔ catégories artistes
-- =========================================================
...
BEGIN
  ...
  -- Les anciennes fiches sont souvent restées au type générique « artist ».
  -- Leur rôle canonique permet désormais de déterminer leur catégorie.
...
-- Normalisation des rôles déjà renseignés.
UPDATE public.artists
SET tags = tags
WHERE COALESCE(cardinality(tags), 0) > 0;

-- Le statut vérifié groupe constitue une preuve explicite.
UPDATE public.artists
...
-- Les crédits de production existants constituent une preuve explicite.

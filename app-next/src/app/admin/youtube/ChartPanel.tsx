  ...
  async function recalculate() {
    await runAction("recalculate", async () => {
      ...
      setNotice({
        ...
        text: `${formatNumber(payload.tracksRanked)} chanson(s) classée(s).`,
      ...
      <section className={styles.panel}>
        <div className={styles.panelHeader}>
          <div>
            ...
            <p>Chargez un brouillon existant ou recalculez le Top 20.</p>
          </div>
        </div>
        <div className={styles.chartToolbar}>
          ...
          <button className="btn btn--primary" type="button" disabled={busyAction !== null} onClick={recalculate}>
            {busyAction === "recalculate" ? "Recalcul..." : "Recalculer"}
          </button>
    ...
    >
      ...
      <div className={styles.rowMain}>
        ...
        <div className={styles.meta}>
          ...
          <span>{formatNumber(entry.eligibleVideoCount)} vidéo(s)</span>
        </div>
        {editing ? (

      ...
      <section className={styles.panel}>
        <div className={styles.panelHeader}>
          <div>
            ...
            <p>Approuvez chaque vidéo officielle et rendez-la éligible. L’association à une chanson est facultative et n’influence pas le classement.</p>
          </div>
...
function VideoEditor({
  ...
  const mustExplainExclusion = reviewStatus === "EXCLUDED";
        ...
        <form onSubmit={submit}>
          <div className={styles.formGrid}>
            ...
            <label className={styles.checkField}>
              ...
              />
              <span>
                <strong>Inclure dans le calcul automatique</strong>
                <small>La vidéo sera classée individuellement dans le prochain brouillon.</small>
              </span>
            </label>
            <label className={`${styles.field} ${styles.fieldFull}`}>
...
function TrackSearch({
  ...
  return (
    <div className={`${styles.field} ${styles.fieldFull}`}>
      <label htmlFor="youtube-track-search">Référence à une chanson (facultative, sans effet sur le classement)</label>
      <input
        id="youtube-track-search"
        value={query}
        onChange={(event) => setQuery(event.target.value)}
        placeholder="Rechercher une chanson, si nécessaire"
      />
      <select
        value={selectedId}
      ...
      >
        <option value="">{loading ? "Recherche..." : "Aucune chanson associée"}</option>

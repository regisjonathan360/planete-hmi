    ...
    <div className={cls}>
      ...
      <div className="entry__actions">
        ...
        {entry.artistIsExcluded ? (
          <Link className="btn btn--sm btn--ghost" href="/admin/artistes?filter=excluded" title="Réintégration depuis la liste des artistes exclus">
            Exclu globalement
          </Link>
        ) : entry.isExcluded ? (
          ...
          <button
            ...
            title="Exclure définitivement cet artiste de toutes les collectes"
          >
            Exclure globalement
          </button>
        )}

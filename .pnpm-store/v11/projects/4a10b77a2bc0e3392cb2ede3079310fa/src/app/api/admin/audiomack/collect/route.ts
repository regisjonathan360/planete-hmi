...
export async function POST(request: Request) {
  ...
  return NextResponse.json({
    ...
    excludedArtists: draftResult.excluded,
    message: `Collecte réussie. ${draftResult.imported} entrées enregistrées en brouillon${draftResult.excluded ? `, ${draftResult.excluded} exclue(s) automatiquement` : ""}. Validation requise dans l'admin.`,
  });
}

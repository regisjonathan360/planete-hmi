    ...
    <>
      ...
      <main className="legal-page">
        <div className="legal-page__wrap">
          ...
          <section>
            <h2>8. Cookies, stockage local et mesure d’audience</h2>
            <p>
              Planète HMI utilise des cookies essentiels pour l’authentification et la
              sécurité, ainsi que le stockage local pour conserver vos choix, vos favoris et
              certaines préférences demandées. Avec votre accord, Vercel Web Analytics fournit
              des statistiques agrégées sans cookie publicitaire. Les espaces privés et les
              paramètres d’URL sont exclus de cette mesure.
            </p>
            <p>
              Vous pouvez accepter, refuser ou retirer ce choix à tout moment depuis le lien
              « Gérer mes cookies » placé dans le pied de page. Le détail des finalités et
              durées est disponible dans notre <a href="/cookies">politique des cookies</a>.
            </p>
          </section>

          <section>
            <h2>9. Paiements et contributions volontaires</h2>
            <p>
              Lors d’une contribution, nous pouvons traiter le nom, l’adresse e-mail, le numéro
              de téléphone, le message, le montant, le moyen de paiement, la référence et le
              statut de la transaction. Les informations bancaires, mots de passe, codes secrets
              et codes OTP ne sont jamais collectés par Planète HMI. PayPal, MonCash, NatCash ou
              le prestataire choisi traite le paiement selon sa propre politique.
            </p>
          </section>
